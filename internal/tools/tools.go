...
func registerSetNodeProperty(server *mcp.Server, deps Deps) {
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Write. Sets a single property (string, integer, floating-point, boolean, " +
			...
			"PackedInt32Array, a PackedFloat32Array, a PackedVector2Array, or a " +
			"PackedColorArray — exactly one of string_value/int_value/float_value/bool_value/" +
			...
			"int_array_value/float_array_value/vector2_array_value/color_array_value must be " +

...
## Transform3D/NodePath/PackedStringArray — the caller sends exactly one of
...
## string_array_value) on one node addressed by node_path (relative to the
